...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_dict:
        ...
        county_results=(
            f"{county_name} : {county_percentage:.2f}%  ({county_vote:,})\n")
    ...
    largest_turnout_county_results= ("\n"
        f"-------------------------\n"
        f"Largest County Turnout: {largest_turnout_county}\n"
        f"-------------------------\n"
    )
    print(largest_turnout_county_results)

    # 8: Save the county with the largest turnout to a text file.
    txt_file.write(largest_turnout_county_results)
